...
pos = [[s[1] for s in sentence] for sentence in getter.sentences]
# print(pos[0])
...
print(type(tokenized_texts[0][0]))
...
for _ in trange(epochs, desc="Epoch"):
    ...
    for step, batch in enumerate(train_dataloader):
        ...
        outputs = model(
            b_input_ids.type(torch.LongTensor),
            token_type_ids=None,
    ...
    for batch in valid_dataloader:
        ...
        label_ids = b_labels.type(torch.LongTensor).to("cpu").numpy()
