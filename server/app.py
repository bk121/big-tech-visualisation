...
app = Flask(__name__, static_folder=os.path.join(dirname, "frontend/build"), static_url_path="")
cors = CORS(app)
app.config["CORS_HEADERS"] = "Content-Type"

load_dotenv()
uri = os.getenv("NEW_NEO4J_URI")
...
def get_article_links():
    ...
    new_client = MongoClient(os.getenv("NEW_MONGO_SERVER"))
    new_db = new_client['InterviewCoach']
    new_collection = new_db["raw_articles"]
